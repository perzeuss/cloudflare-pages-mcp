...
* **compose:** forward all supported env vars ([#12](https://github.com/perzeuss/cloudflare-pages-mcp/issues/12)) ([371b224](https://github.com/perzeuss/cloudflare-pages-mcp/commit/371b22459d36d38345282007acad3633bf2cffe7))
* **oauth:** don't block the consent form with CSP form-action ([#38](https://github.com/perzeuss/cloudflare-pages-mcp/issues/38)) ([ca2d2c0](https://github.com/perzeuss/cloudflare-pages-mcp/commit/ca2d2c0cd495580e6fbd6face53f6c7deb961c77)), closes [hi#severity](https://github.com/hi/issues/severity)


### Features

* Cloudflare Pages MCP server (create projects + deploy files) ([d83eb43](https://github.com/perzeuss/cloudflare-pages-mcp/commit/d83eb431c77aa56db6a9a8446d5734ad63b702fe))
* disk-based deploy workflow with batch upload URLs and upload skill ([#1](https://github.com/perzeuss/cloudflare-pages-mcp/issues/1)) ([7e5a3b1](https://github.com/perzeuss/cloudflare-pages-mcp/commit/7e5a3b10bbff23f7cac736a1d2d8cc526d235ca2))
* extend opt-in CORS to /health and broaden allowed headers ([#11](https://github.com/perzeuss/cloudflare-pages-mcp/issues/11)) ([88f771b](https://github.com/perzeuss/cloudflare-pages-mcp/commit/88f771b6df1198c9755367aa3dfda1538b409ee9))
* opt-in CORS for the /upload endpoint (UPLOAD_ALLOWED_ORIGINS) ([#9](https://github.com/perzeuss/cloudflare-pages-mcp/issues/9)) ([4fddd44](https://github.com/perzeuss/cloudflare-pages-mcp/commit/4fddd44c3dc9a45a3d39ec6886cdc5c7d289f0a1))
